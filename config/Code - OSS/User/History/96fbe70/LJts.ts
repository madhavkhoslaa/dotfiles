...
AthleteMetricsSchema.index({ metric: 1, athleteID: 1, createdAt: 1 }, { unique: true });

const Athletemetrics = model<AthleteMetricsDocument>('athlete_metrics', AthleteMetricsSchema);
