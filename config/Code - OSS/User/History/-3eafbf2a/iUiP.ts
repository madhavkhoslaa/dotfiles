...
import { athleteRouter } from "./controllers/AthleteView";
import { exerciseChartRouter } from "./controllers/exerciseChart";
console.log(config);
const app = App();
...
app.use("/exerciseChart", Auth, exerciseChartRouter);
